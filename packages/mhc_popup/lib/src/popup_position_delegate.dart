...
class PopupAlignPositionDelegate extends PopupPositionDelegate {
  ...
  Offset _computePosition(
    ...
    return keyAlignment.withinRect(keyRect) -
        popupAlignment.alongSize(popupSize);
  }
  ...
  Offset _shiftToContains(Offset pos, Offset overlaps) {
    return pos - Offset(overlaps.dx, overlaps.dy);
  }
  ...
  Offset _copy({
    ...
    return Offset(saveX ? src.dx : dst.dx, saveY ? src.dy : dst.dy);
  }
